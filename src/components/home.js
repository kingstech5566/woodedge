...
import eor from "./images/record.png"
    ...
    return(
        <section className="home">
            ...
            <div className="next">
                ...
                <ol>
                    <li className="li"><img src={eor} alt="" width="30" /><b>EOR services in Nigeria∹</b><br/>We serve as trusted local partner, managing everything from employee contracts and HR administration to payroll and tax compliance. By acting as your EOR(Employer of Record), we ensure full legal compliance with Nigeria employment laws, proctecting your business form regulatory risks.</li>
                    <li className="li"><img src={employ} alt="" width="30" /><b>Employment Legal Compliance∹</b><br/>Staying compliant with Nigeria's labor regulations is crucial for any business. Our team is well-versed in Nigeria's complex labor codes and works proactively to keep your compliant. We handle all local requirements for employment, taxes and benefits, ensuring your work force remain compliant with Nigerian employment laws.</li>
                    <li className="li"><img src={manage} alt="" width="30" /><b>HR Management and Support∹</b><br/>From recruiting and onboarding to managing employee relations, we provide full HR support, acting as your HR department in Nigeria. With our hands-on approach, we help you build a high-performing team while handling all HR functions and administrative tasks locally.</li>
                    <li className="li"><img src={payroll} alt="" width="30" /><b>Payroll and Benefits Administration∹</b><br/>We ensure prompt, accurate payroll management tailored to Nigerian standards. Our team manages employee benefits and payroll distribution, ensuring your team is supported and compensated correctly, following Nigerian legal standards.</li>
                    <li className="li"><img src={risk} alt="" width="30" /><b>Risk and Compliance Assurance∹</b><br/>Operating internationally comes with challenges, but our risk management and compliance assurance help mitigate them. We manage employment-related risks, ensuring your business operates smoothly and within legal bounds.</li>
                </ol>
            </div>
            <div className="image">
